...
- Animation tracks metadata are configured in the editor, not the code.
...
- you can change animation per instance but no blending or transitions between animation tracks.
